...
const schema = z.object({
    ...
    nombre: z.string().trim()
        .min(1, { message: "Al menos debe tener una letra" })
        .max(5, { message: "Como máximo debe haber 5 letras" }),
    edad: z.coerce.number()
        .min(18, "La edad mínima debe ser 18 años")
        .max(65, "La edad máxima debe ser 65 años"),
    telefono: z.string().trim()
        .regex(/[678]{1}[0-9]{8}/, { message: "Escribe 9 dígitos, siendo el primero 6,7 u 8" }),
    email: z.string().email({ message: "Email no válido" }),
    fecha: z.coerce.date()
        .min(new Date("2024-01-01"), { message: "La fecha debe estar dentro del año 2024" })
        .max(new Date("2024-12-31"), { message: "La fecha debe estar dentro del año 2024" }),
